...
const services = [
  { number: '01', title: 'Private companionship', text: 'Thoughtful, discreet company for dinners, cultural outings, travel days, and the ordinary moments that feel better shared. Every introduction begins with a clear conversation about preferences, pace, and boundaries.' },
  { number: '02', title: 'Event companionship', text: 'Arrive feeling composed and supported. Companios can accompany you to receptions, weddings, galas, conferences, and private occasions with social ease, polished presence, and respect for your plans.' },
  { number: '03', title: 'Wellness & massage', text: 'A calm, professional wellness experience designed around relaxation and restorative touch. We discuss comfort, pressure, accessibility, and the setting before every appointment.' },
]
